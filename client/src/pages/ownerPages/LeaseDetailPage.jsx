...
const LeaseDetailPage = () => {
  ...
  return (
    <main className="flex flex-col gap-6 items-center lg:items-start lg:ml-10 mt-8">
      ...
      <div className="flex flex-col lg:flex-row gap-4 mx-2 md:mx-0">
        ...
        <div>
            <p className="">
              <span className="font-semibold font-robotoNormal">
                Lease Start Date
              </span>
            ...
            <div className="flex flex-col gap-2 p-4 shadow-md rounded-md border border-gray-200">
              ...
              <div>
                ...
                <p>
                  Relationship:{" "}
                  <span className="font-robotoNormal">
                    {leaseDetail?.tenantInformation?.emergencyContact?.relationship}
                  </span>
                </p>
                <p>
                  Phone Number:{" "}
                  <span className="font-robotoNormal">
                    {leaseDetail?.tenantInformation?.emergencyContact?.phoneNumber}
                  </span>
                </p>
              </div>
            </div>
      ...
      <div
        className={`flex flex-col gap-2 p-4 mx-2 md:mx-0 ${!isAgreementCollapsed && "shadow-md rounded-md border border-gray-200"
          }`}
      >
        <div className="flex justify-start items-center gap-2">
          ...
          <div className="flex flex-col gap-4 w-full mx-2 md:mx-0 p-4 lg:-ml-6 shadow-md rounded-md border border-gray-200 items-center my-6">
            ...
            <div className="flex justify-start mt-6">
              <Button
                ...
                startIcon={flags.isPendingUpdated ? <ChecklistIcon /> : <RemoveCircleRoundedIcon />}
            >
                {isProcessing ? (
                  <CircularProgress
                  size={26}
